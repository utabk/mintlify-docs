...
│   ├── vesting/VestingSchedule.sol
│   ├── staking/StakeRewards.sol
│   └── multisig/MultiSig.sol
├── test/
│   ├── token/ManagedToken.t.sol
│   ├── vesting/VestingSchedule.t.sol
│   ├── staking/StakeRewards.t.sol
│   └── multisig/MultiSig.t.sol
└── scripts/
    ├── deploy-token.js
    └── setup-vesting.js
```
